            ...
            <section class="content">
                ...
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title">เครื่องชั่งที่ 02</h3>
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <form id="form1" action="insert_scale02.php" method="post" class="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <form id="form1" action="insert_scale02.php" method="post" class="form" enctype="multipart/form-data" novalidate>
                                                        <div class="form-group">
