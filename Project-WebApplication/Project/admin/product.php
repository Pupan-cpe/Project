    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            ?>
                ...
                <section class="content-header">
                    <h1>
                        สินค้า
                        <small>จัดการข้อมูลสินค้าโรงงานที่1</small>
                    </h1>
                    <ol class="breadcrumb">
     ...
     scale01.pt_date";
                        ...
                        <div class="box-body">
                            ...
                            <table id="table" data-toggle="table" data-url="product_json.php" data-pagination="true" data-page-size="10" data-page-list="[5,10,15,ALL]" data-search="true" data-height="500" data-toolbar="#toolbar" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-id-field="order_id">
